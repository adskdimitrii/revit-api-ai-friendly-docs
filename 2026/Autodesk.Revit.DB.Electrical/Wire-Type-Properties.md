...
Source: https://www.revitapidocs.com/2026/01fcb5b7-d167-562b-3aa9-70183545643a.htm
...
The [WireType](Wire-Type-Class.md) type exposes the following members. 
...
| ![Public property](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/pubproperty.gif "Public property") | [CanBeCopied](588e4fac-5492-0e1d-c935-dfd53e801c04.htm) | Determine if this ElementType can create a copy (Inherited from [ElementType](../Autodesk.Revit.DB/Element-Type-Class.md) ) |
| ![Public property](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/pubproperty.gif "Public property") | [CanBeDeleted](5efe8253-d555-00c2-8db6-9114e328fcc7.htm) | Determine if this ElementType can be deleted (Inherited from [ElementType](../Autodesk.Revit.DB/Element-Type-Class.md) ) |
| ![Public property](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/pubproperty.gif "Public property") | [CanBeRenamed](ce2e0f26-deaf-d649-0617-babde54c6bf7.htm) | Determine if this ElementType can be renamed (Inherited from [ElementType](../Autodesk.Revit.DB/Element-Type-Class.md) ) |
...
| ![Public property](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/pubproperty.gif "Public property") | [Conduit](36b57a53-b35b-cd17-75b8-bacd8471999f.htm) | The conduit type of the wire type. |
...
| ![Public property](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/pubproperty.gif "Public property") | [FamilyName](10de5c66-1b4b-9214-4036-27a6b24e5703.htm) | Gets the family name of this element type. (Inherited from [ElementType](../Autodesk.Revit.DB/Element-Type-Class.md) ) |
...
| ![Public property](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/pubproperty.gif "Public property") | [Insulation](Wire-Type-Insulation-Property.md) | The conductor insulation material of the wire type. |
| ![Public property](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/pubproperty.gif "Public property") | [IsInUse](02086d4b-eac0-ab0d-98ab-e56d425b7255.htm) | Indicates whether the wire type is in use. |
...
| ![Public property](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/pubproperty.gif "Public property") | [MaxSize](Wire-Type-Max-Size-Property.md) | The max conductor size name of the wire type. |
| ![Public property](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/pubproperty.gif "Public property") | [Name](1198805b-fdbf-54bf-64d3-90dbd01b4c5f.htm) | Set the name for the ElementType. (Inherited from [ElementType](../Autodesk.Revit.DB/Element-Type-Class.md) ) |
| ![Public property](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/pubproperty.gif "Public property") | [NeutralMultiplier](f7678fb7-e63f-fb06-6c50-e41afa4b7675.htm) | The neutral multiplier type of the wire type. |
| ![Public property](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/pubproperty.gif "Public property") | [NeutralRequired](8b4f997f-4fbd-c2f3-8e49-d5d3d7e53afd.htm) | Whether or not the neutral point is required. |
| ![Public property](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/pubproperty.gif "Public property") | [NeutralSize](57328dfd-0b5e-9925-c6ed-9451dd3d7189.htm) | The maximum neutral size of the wire type. |
...
| ![Public property](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/pubproperty.gif "Public property") | [TemperatureRating](Wire-Type-Temperature-Rating-Property.md) | The conductor temperature rating of the wire type. |
...
| ![Public property](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/pubproperty.gif "Public property") | [WireMaterial](Wire-Type-Wire-Material-Property.md) | The conductor material of the wire type. |
