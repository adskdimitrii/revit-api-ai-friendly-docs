# Analytical Member Properties

Source: https://www.revitapidocs.com/2026/4fa1b559-e38b-031c-44ef-c98d9c05f62e.htm
...
The [AnalyticalMember](Analytical-Member-Class.md) type exposes the following members. 

![](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/sectionexpanded.png)Properties 

|  | Name | Description |
| --- | --- | --- |
| ![Public property](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/pubproperty.gif "Public property") | [AnalyzeAs](571db5af-db0b-c5a0-afc0-746c80cf9721.htm) | This represents the Analyze As parameter assigned to Analytical Element. (Inherited from [AnalyticalElement](Analytical-Element-Class.md) ) |
...
| ![Public property](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/pubproperty.gif "Public property") | [ConnectorManager](Analytical-Element-Connector-Manager-Property.md) | Retrieves the Connector Manager from this AnalyticalElement. (Inherited from [AnalyticalElement](Analytical-Element-Class.md) ) |
...
| ![Public property](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/pubproperty.gif "Public property") | [CrossSectionRotation](aaa42138-0ce6-4adc-992f-eb658d99aab9.htm) | This represents the cross\-section rotation, in radians. |
...
| ![Public property](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/pubproperty.gif "Public property") | [MaterialId](919f020c-953a-3d08-0743-57dc1d3dc398.htm) | Defines the Material Id for the Analytical Element. (Inherited from [AnalyticalElement](Analytical-Element-Class.md) ) |
...
| ![Public property](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/pubproperty.gif "Public property") | [SectionTypeId](5e8a8f22-82e6-1a60-2ca1-bea0ea6a86a1.htm) | The id of the type from the structural Family assigned to the Analytical Member. |
| ![Public property](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/pubproperty.gif "Public property") | [StructuralRole](e7dfb391-f0d6-9aef-8ba9-b8f05e269329.htm) | The enum value depicting structural role asigned to the Analytical Element. (Inherited from [AnalyticalElement](Analytical-Element-Class.md) ) |
| ![Public property](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/pubproperty.gif "Public property") | [StructuralSectionShape](74d01c4a-9032-e740-2338-e9a8ec6711d5.htm) | The structural section shape of the Analytical Member. |
...
[AnalyticalMember Class](Analytical-Member-Class.md) [Autodesk.Revit.DB.Structure Namespace](../ungrouped/Autodesk.-Revit.-DB.-Structure-Namespace.md)
