# Browser Organization Get Sorting Parameter Id Path Method

Source: https://www.revitapidocs.com/2026/fc632868-4931-1c5e-2603-37a9b17e0b6c.htm
...
IList [ElementId](Element-Id-Class.md) ![](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/sectionexpanded.png)Remarks A parameter Id path consists of reference parameter Id(s) {0\...n} \+ paramId,
 and the value of the last parameter in the path is the one that is used to determine the sorting order of items in the browser.
