# IFCCategory Template Class

Source: https://www.revitapidocs.com/2026/291d1bc9-cff6-b447-b72f-7d962b42b49f.htm
...
Represents an element that contains an IFC category mapping template stored in a Revit document. ![](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/sectionexpanded.png)Inheritance Hierarchy System Object 
...
|  | Name | Description |
| --- | --- | --- |
| ![Public method](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/pubmethod.gif "Public method") | [IFCCategoryTemplate](b11f6251-400c-4cfd-4719-0b8a086bab5b.htm) | Custom constructor for this element. |
...
| ![Public property](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/pubproperty.gif "Public property") | [IsValidCategoryMappingFile](IFCCategory-Template-Is-Valid-Category-Mapping-File-Property.md) | Whether or not the category mapping file is valid. |
...
| ![Public method](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/pubmethod.gif "Public method") | [CopyTemplate](IFCCategory-Template-Copy-Template-Method.md) | Create copy of mapping template with new name. |
| ![Public method](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/pubmethod.gif "Public method")![Static member](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/static.gif "Static member") | [Create](IFCCategory-Template-Create-Method.md) | Create a IFC category mapping template with default values. |
...
| ![Public method](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/pubmethod.gif "Public method") | [ExportToFile](5e33fc18-a7d6-c0e5-e43e-e1a56f71db75.htm) | Export mapping template to a text file. |
| ![Public method](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/pubmethod.gif "Public method")![Static member](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/static.gif "Static member") | [FindByName](b71fda2c-869c-e7d8-5af1-9b0a3333a8f4.htm) | Returns mapping template element by name. |
| ![Public method](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/pubmethod.gif "Public method")![Static member](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/static.gif "Static member") | [GetActiveTemplate](IFCCategory-Template-Get-Active-Template-Method.md) | Gets the active mapping template element in the document. |
| ![Public method](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/pubmethod.gif "Public method") | [GetCategoryMappingTable](cf72fe8f-b5f6-18cd-7150-9c40ea216a54.htm) | Gets the table that contains a mapping from Revit categories to IFC entities. |
...
| ![Public method](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/pubmethod.gif "Public method") | [GetMappingInfoById](IFCCategory-Template-Get-Mapping-Info-By-Id-Method.md) | Gets a copy of IFC mapping info by category id. |
...
| ![Public method](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/pubmethod.gif "Public method")![Static member](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/static.gif "Static member") | [GetOrCreateInSessionTemplate](IFCCategory-Template-Get-Or-Create-In-Session-Template-Method.md) | Gets the in\-session non\-serializable template or create new. |
...
| ![Public method](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/pubmethod.gif "Public method")![Static member](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/static.gif "Static member") | [ImportFromFile](IFCCategory-Template-Import-From-File-Method.md) | Import mapping template from a text file. |
...
| ![Public method](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/pubmethod.gif "Public method")![Static member](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/static.gif "Static member") | [IsValidName](b0a3e046-b2e5-78a4-7133-07ff384fe00c.htm) | Returns result that the proposed name is valid and not exist in the specified document. |
...
| ![Public method](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/pubmethod.gif "Public method")![Static member](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/static.gif "Static member") | [ListNames](IFCCategory-Template-List-Names-Method.md) | Returns a list of names of IFC export mapping templates. |
...
| ![Public method](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/pubmethod.gif "Public method")![Static member](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/static.gif "Static member") | [ResetActiveTemplate](IFCCategory-Template-Reset-Active-Template-Method.md) | Removes the information about active mapping temple of the document. |
| ![Public method](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/pubmethod.gif "Public method") | [ResetCategoryToDefault](c16d57a7-f360-8776-dce8-860b85396906.htm) | Reset one category, sub\-category, or special category in the current mapping table to the default values defined in Revit |
| ![Public method](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/pubmethod.gif "Public method") | [SetActiveTemplate](IFCCategory-Template-Set-Active-Template-Method-2.md) | Sets the mapping template element to be the active mapping template for its document. |
| ![Public method](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/pubmethod.gif "Public method") | [SetActiveTemplate(Document)](IFCCategory-Template-Set-Active-Template-Document-Method.md) | **Obsolete.** Sets the mapping template element to be the active mapping template in the document. |
...
| ![Public method](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/pubmethod.gif "Public method") | [SetMappingInfo(IDictionary ExportIFCCategoryKey, ExportIFCCategoryInfo )](1db0660b-0844-dbc6-45ad-1a834c7393b6.htm) |  |
| ![Public method](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/pubmethod.gif "Public method") | [SetMappingInfo(ExportIFCCategoryKey, ExportIFCCategoryInfo)](23a63f03-b0dc-bc89-ec3b-0822cf1c9120.htm) | Set the mapping info for the key. |
...
| ![Public method](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/pubmethod.gif "Public method") | [UpdateCategoryList](086a1260-b82d-ae84-7288-e5af0887ebf8.htm) | Updates the mapping table with the categories from the document. |
