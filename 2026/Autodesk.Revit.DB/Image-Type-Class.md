...
Source: https://www.revitapidocs.com/2026/c6213f81-8dc8-158e-0522-70f87e9bdbb9.htm
...
Represents a type containing a raster based image. ImageInstances of this type can be placed in 2D views, sheets, and schedules. ![](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/sectionexpanded.png)Inheritance Hierarchy System Object 
...
| ![Public property](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/pubproperty.gif "Public property") | [CanBeCopied](588e4fac-5492-0e1d-c935-dfd53e801c04.htm) | Determine if this ElementType can create a copy (Inherited from [ElementType](Element-Type-Class.md) ) |
| ![Public property](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/pubproperty.gif "Public property") | [CanBeDeleted](5efe8253-d555-00c2-8db6-9114e328fcc7.htm) | Determine if this ElementType can be deleted (Inherited from [ElementType](Element-Type-Class.md) ) |
| ![Public property](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/pubproperty.gif "Public property") | [CanBeRenamed](ce2e0f26-deaf-d649-0617-babde54c6bf7.htm) | Determine if this ElementType can be renamed (Inherited from [ElementType](Element-Type-Class.md) ) |
...
| ![Public property](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/pubproperty.gif "Public property")![Static member](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/static.gif "Static member") | [ExternalResourceType](87b4d0ea-c7bb-8063-b4d4-c81b9213ca55.htm) | The type of external resources that represents images. |
| ![Public property](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/pubproperty.gif "Public property") | [FamilyName](10de5c66-1b4b-9214-4036-27a6b24e5703.htm) | Gets the family name of this element type. (Inherited from [ElementType](Element-Type-Class.md) ) |
...
| ![Public property](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/pubproperty.gif "Public property") | [Height](d28540c9-4ae4-420f-ad9b-ce1d92cf1114.htm) | The vertical size of the image |
| ![Public property](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/pubproperty.gif "Public property") | [HeightInPixels](ec9625b0-d4d4-0430-4407-3d3f56f4ce0f.htm) | Number of pixels in the vertical direction of the image |
...
| ![Public property](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/pubproperty.gif "Public property") | [Name](1198805b-fdbf-54bf-64d3-90dbd01b4c5f.htm) | Set the name for the ElementType. (Inherited from [ElementType](Element-Type-Class.md) ) |
...
| ![Public property](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/pubproperty.gif "Public property") | [PageNumber](2500b06c-f131-8d7b-3fb4-bd3e66335708.htm) | The number of the page in a multi\-page file, that was used to create the image in the ImageType. |
...
| ![Public property](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/pubproperty.gif "Public property") | [Path](11e87696-9900-94f4-48f9-2e307dd9aae1.htm) | The path to the file from which the ImageType was loaded. |
| ![Public property](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/pubproperty.gif "Public property") | [PathType](c50808f3-77e5-9606-ec79-721c03873ed2.htm) | The path type that was used to refer to the file from which the ImageType was loaded. |
...
| ![Public property](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/pubproperty.gif "Public property") | [Resolution](f87ffd66-9385-3380-d1fd-41fe0f045067.htm) | The size of the pixels in the image, expressed in dots\-per\-inch (dpi) |
| ![Public property](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/pubproperty.gif "Public property") | [Source](ebd4da4a-d8da-fe29-8eb4-0c20b678ae02.htm) | The source of the image in the ImageType. |
| ![Public property](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/pubproperty.gif "Public property") | [Status](5f3ddbfe-0d79-a6d4-4170-d9615a764622.htm) | The status of the image |
...
| ![Public property](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/pubproperty.gif "Public property") | [Width](80cccf6d-e10b-8c8b-f536-b3d2e9443a75.htm) | The horizontal size of the image |
| ![Public property](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/pubproperty.gif "Public property") | [WidthInPixels](2e5bdc03-43f0-e718-7c7b-75781cdfdb19.htm) | Number of pixels in the horizontal direction of the image |
...
| ![Public method](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/pubmethod.gif "Public method") | [CanReload](6090600f-8d4c-511d-a7c5-a21caf768bfc.htm) | Check whether the ImageType can be reloaded from file. |
...
| ![Public method](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/pubmethod.gif "Public method")![Static member](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/static.gif "Static member") | [Create](31bb13e3-e8f5-cb66-18d0-619578d56cde.htm) | Creates a new ImageType element and loads the image into it. |
...
| ![Public method](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/pubmethod.gif "Public method") | [Duplicate](b0e7d5d5-f33a-8ff2-b471-78a213f06ef5.htm) | Duplicates an existing element type and assigns it a new name. (Inherited from [ElementType](Element-Type-Class.md) ) |
...
| ![Public method](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/pubmethod.gif "Public method") | [GetImage](39ae2f0d-11f1-96be-e12b-bfbc4a6c7fae.htm) | Get the bitmap image stored in the image symbol. |
...
| ![Public method](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/pubmethod.gif "Public method") | [GetPreviewImage](e79da134-713a-2202-4898-cca930202dff.htm) | Get the preview image of an element. This image is similar to what is seen in the Revit UI when selecting the type of an element. (Inherited from [ElementType](Element-Type-Class.md) ) |
| ![Public method](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/pubmethod.gif "Public method") | [GetSimilarTypes](2719ca23-11c7-dda4-6291-9a4f0cebfb21.htm) | Obtains a set of types that are similar to this type. (Inherited from [ElementType](Element-Type-Class.md) ) |
...
| ![Public method](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/pubmethod.gif "Public method") | [IsSimilarType](bd1e5459-4909-dc8a-46fd-54540fe1961e.htm) | Checks if given type is similar to this type. (Inherited from [ElementType](Element-Type-Class.md) ) |
| ![Public method](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/pubmethod.gif "Public method") | [IsValidDefaultFamilyType](db029b02-e415-3807-d724-ec32b505d23a.htm) | Identifies if this type is a valid default family type for the given family category id. (Inherited from [ElementType](Element-Type-Class.md) ) |
...
| ![Public method](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/pubmethod.gif "Public method") | [Reload](9d45a435-bf47-e6a7-15b2-7f5584d260ec.htm) | Reloads the ImageType from the file found at the location specified by the [Path](11e87696-9900-94f4-48f9-2e307dd9aae1.htm) property,  using the same [PageNumber](2500b06c-f131-8d7b-3fb4-bd3e66335708.htm) and resolution. |
| ![Public method](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/pubmethod.gif "Public method") | [ReloadFrom](e009ad38-c172-fdf4-56b8-c3be5940cc05.htm) | Reloads the image in the ImageType from a new image file, and for a new [PageNumber](2500b06c-f131-8d7b-3fb4-bd3e66335708.htm) . |
...
| ![Public method](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/pubmethod.gif "Public method") | [Unload](386b1797-4550-8e3d-d67e-0ac45e2091b0.htm) | Unload the linked image. |

[Top](#PageHeader) ![](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/sectionexpanded.png)Remarks ImageType elements are created with the ImageType.Create(Document, ImageTypeOptions) method. 
