# Independent Tag Class

Source: https://www.revitapidocs.com/2026/e52073e2-9d98-6fb5-eb43-288cf9ed2e28.htm
...
Represents tag annotations in Revit.
 getBBoxCorers in MultipleAlignmentHelper needs access to some protected members. ![](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/sectionexpanded.png)Inheritance Hierarchy System Object 
[Autodesk.Revit.DB Element](Element-Class.md) 
Autodesk.Revit.DB IndependentTag 
[Autodesk.Revit.DB SpanDirectionSymbol](15890f37-0c4c-2b2e-8f34-a575baee7f14.htm) 
...
| ![Public property](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/pubproperty.gif "Public property") | [HasLeader](ce3fe3a9-4048-3b29-4dcb-57ca86de4267.htm) | Identifies if a tag has at least one visible leader, or if all leaders are hidden. |
...
| ![Public property](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/pubproperty.gif "Public property") | [IsMaterialTag](7670e365-227c-bc9d-a4b0-c77f793034e2.htm) | Identifies if it is a material tag or not. |
...
| ![Public property](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/pubproperty.gif "Public property") | [IsMulticategoryTag](91f6e4f0-6a6b-efa6-5730-ea32a5cb203c.htm) | Identifies if it is a multi\-category tag or not. |
| ![Public property](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/pubproperty.gif "Public property") | [IsOrphaned](4906fa9c-e424-92e7-0b7e-15389726ca78.htm) | Identifies if the tag is orphaned or not. |
...
| ![Public property](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/pubproperty.gif "Public property") | [LeaderEndCondition](0b0575d6-446d-d3e8-3ef7-12faed553b20.htm) | The leader end condition of the tag, such as if the end of the leader is attached to the host or free floating. |
| ![Public property](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/pubproperty.gif "Public property") | [LeadersPresentationMode](f0d5e29e-0407-cdc0-cdf7-69ea516bd632.htm) | Identifies the Presentation Mode that is applied to tag leaders. |
...
| ![Public property](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/pubproperty.gif "Public property") | [MergeElbows](5c5ad800-7512-be12-dc1a-ebcda5513622.htm) | Identifies if the leaders' elbows are merged or not. If they are are merged, all elbows are in the same point and they move together. |
| ![Public property](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/pubproperty.gif "Public property") | [MultiLeader](5501affb-b03f-8bca-de56-c12a42915bc6.htm) | Returns if the tag if referencing multiple elements and/or sub\-elements. |
| ![Public property](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/pubproperty.gif "Public property") | [MultiReferenceAnnotationId](30363f1b-0fd1-fa0e-5617-be77d683662e.htm) | The multi\-reference annotation which owns this tag. |
| ![Public property](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/pubproperty.gif "Public property") | [Name](e372092e-ff47-71c2-1272-50ab08e5a41d.htm) | A human readable name for the Element. (Inherited from [Element](Element-Class.md) ) |
...
| ![Public property](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/pubproperty.gif "Public property") | [RotationAngle](3b257113-5220-c9df-dd3c-50e1e28b847b.htm) | The rotation angle of the tag relative to its view |
| ![Public property](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/pubproperty.gif "Public property") | [TagHeadPosition](4f49d3f3-e5c5-108a-49dd-2a36697bd08e.htm) | The position of the head of tag in model coordinates. |
| ![Public property](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/pubproperty.gif "Public property") | [TagOrientation](d9d43a13-a972-3b69-2484-b6e336e9a0c5.htm) | The tag orientation of the tag's head, such as horizontal or vertical. |
| ![Public property](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/pubproperty.gif "Public property") | [TagText](8e297dee-920d-f620-6198-0bed494e3f04.htm) | The text associated with the tag. If there are several strings assiciated with the tag, the strings will be returned concatenated. |
...
|  | Name | Description |
| --- | --- | --- |
| ![Public method](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/pubmethod.gif "Public method") | [AddReferences](333fc505-2f6b-e754-6841-fb7f7639284e.htm) |  |
...
| ![Public method](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/pubmethod.gif "Public method") | [CanLeaderEndConditionBeAssigned](83343fd7-5244-12ae-faa0-3fcf082d483e.htm) | Checks whether the LeaderEndCondition can be changed. |
...
| ![Public method](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/pubmethod.gif "Public method")![Static member](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/static.gif "Static member") | [Create(Document, ElementId, ElementId, Reference, Boolean, TagOrientation, XYZ)](b8e8eec2-8e3b-08f2-a9a5-89f24465c8b9.htm) | Places a tag on an element or subelement. |
| ![Public method](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/pubmethod.gif "Public method")![Static member](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/static.gif "Static member") | [Create(Document, ElementId, Reference, Boolean, TagMode, TagOrientation, XYZ)](1f622654-786a-b8fd-1f81-278698bacd5b.htm) | Places a tag on an element or subelement. |
...
| ![Public method](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/pubmethod.gif "Public method") | [GetLeaderElbow](cb3f9617-d5a4-7c45-1686-d7c2f60effad.htm) | Returns the position of the elbow of the tag's leader that points to specified reference.  Position of leader's elbow. |
| ![Public method](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/pubmethod.gif "Public method") | [GetLeaderEnd](d6f69738-aa40-d45c-5ab5-ba02d55d0837.htm) | Returns the end position of the tag's leader that points to specified reference. |
...
| ![Public method](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/pubmethod.gif "Public method") | [GetTaggedElementIds](43260944-f46c-d5df-c9ea-f3a44e24d1a2.htm) | Returns a set of LinkElementId for all tagged elements, if any. A LinkElementId will be provided for each  subelement that is being referenced by the tag. |
| ![Public method](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/pubmethod.gif "Public method") | [GetTaggedLocalElementIds](142026b1-69d5-7b1e-f5b3-3360abc0f9be.htm) | Returns a set of IDs for all tagged local elements, if any. A local element ID will be provided for each  subelement that is being referenced by the tag.  Set of all the element ids in the local file.  For each subelement a local element id will be provided. |
| ![Public method](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/pubmethod.gif "Public method") | [GetTaggedLocalElements](f238e2c7-e184-172c-546a-7dd694857e56.htm) | Get the tagged local elements, if any.  An Element will be provided for each subelement that is being referenced by the tag. |
| ![Public method](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/pubmethod.gif "Public method") | [GetTaggedReferences](63a90870-6b37-57b2-26fe-6fa1e605a9da.htm) | Get the host references of the tag.  An array of all the tagged references. |
...
| ![Public method](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/pubmethod.gif "Public method") | [HasLeaderElbow](f4febfed-3134-a5c0-0f8e-d4e6c5b4b675.htm) | Whether the tag's leader that points to the reference has an elbow point or not. |
...
| ![Public method](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/pubmethod.gif "Public method") | [HasTagBehavior](fadc39b4-eb80-2e00-f9af-e5752a0bb498.htm) | Checks if the IndependentTag has a tag behavior. |
| ![Public method](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/pubmethod.gif "Public method") | [HasTagText](e32f82d2-9aaa-5845-397f-6ff9264ad31b.htm) | Checks if the IndependentTag has a valid tag text. |
...
| ![Public method](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/pubmethod.gif "Public method") | [IsLeaderVisible](8ad822df-1fb8-938f-66d4-60ade8983c40.htm) | Returns if leader that points to specified reference is visible or not. |
...
| ![Public method](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/pubmethod.gif "Public method") | [IsTaggedOnSubelement](8f6f8b8c-1b1b-1141-e165-1eecd4b765a1.htm) | Returns true if the any of the tagged references is a subelement. |
...
| ![Public method](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/pubmethod.gif "Public method") | [RemoveReferences](902f7f27-964e-d7cd-e582-07f45750d768.htm) |  |
...
| ![Public method](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/pubmethod.gif "Public method") | [SetIsLeaderVisible](b0b7f9bc-163b-01a6-9a8c-fa7cfc6c61a0.htm) | Set tag's leader that points to specified reference to be visible or not. This option can be set only if the LeadersPresentationMode is ShowSpecificLeaders. |
| ![Public method](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/pubmethod.gif "Public method") | [SetLeaderElbow](dd5a7d21-cb13-d3d7-6dd6-8e8e427e4873.htm) | Set the position of the elbow of the tag's leader that points to specified reference.  If this tag is a multileader tag and the elbows are merged, the input position will be set to all leaders. |
| ![Public method](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/pubmethod.gif "Public method") | [SetLeaderEnd](fb54c007-6873-68f4-4772-e777609a441b.htm) | Set the end position of the tag's leader that points to specified reference. |
...
[Top](#PageHeader) ![](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/sectionexpanded.png)Remarks IndependentTag represents single\-category tags, multi\-category tags, material tags, and zone tags.
 IndependentTag is also the base class for other annotations like keynote tags and span symbols.
 Room, area and space tags are not derived from IndependentTag. \[!:Autodesk::Revit::DB::SpatialElementTag] for more information. ![](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/sectionexpanded.png)See Also 
