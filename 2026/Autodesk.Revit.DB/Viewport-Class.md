...
Source: https://www.revitapidocs.com/2026/5991dc40-234a-4835-cc06-07524d2e61a4.htm
...
An element that establishes the placement of a view on a sheet. ![](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/sectionexpanded.png)Inheritance Hierarchy System Object 
...
| ![Public property](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/pubproperty.gif "Public property") | [LabelLineLength](1b9cdb90-85ba-424a-3df0-33cab7d066f6.htm) | The length of the viewport label line in sheet space, measured in feet. |
| ![Public property](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/pubproperty.gif "Public property") | [LabelOffset](d2856541-4f08-f212-99b3-0eee98bdb43c.htm) | The offset is a two\-dimensional vector from left bottom corner of the viewport with Rotation set to None to the left end of the viewport label line. The Z coordinate is ignored. |
...
| ![Public property](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/pubproperty.gif "Public property") | [Rotation](abd81744-b44a-e578-cb62-3cc40a334acc.htm) | The rotation of the viewport on the sheet. |
| ![Public property](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/pubproperty.gif "Public property") | [SheetId](187ece0f-f732-ec3c-1f20-ad688b8c1499.htm) | The element id of the ViewSheet on which the viewport appears,  or InvalidElementId if this viewport does not associate a view  with placement onto a sheet. |
...
| ![Public property](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/pubproperty.gif "Public property") | [ViewAnchor](Viewport-View-Anchor-Property.md) | Specifies the method by which the view will be positioned on the sheet and for the case when it is swapped to another view. Default is set to ViewAnchor.ViewOrigin. |
| ![Public property](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/pubproperty.gif "Public property") | [ViewId](f96f5255-17b5-d4fc-c3a3-049fae1f6eb9.htm) | The element id of the associated View. |
| ![Public property](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/pubproperty.gif "Public property") | [ViewportPositioning](Viewport-Viewport-Positioning-Property.md) | **Obsolete.** Specifies the method the viewport will be positioned on the sheet when swapped to another view. Default is set to ViewportPositioning::ViewportCenter. |
| ![Public property](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/pubproperty.gif "Public property") | [ViewPosition](Viewport-View-Position-Property.md) | Specifies view's position. Default is set to XYZ.Zero. |
...
| ![Public method](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/pubmethod.gif "Public method")![Static member](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/static.gif "Static member") | [CanAddViewToSheet](1da33e38-255f-a27a-0626-9891d897b29a.htm) | Verifies that the view can be added to the ViewSheet. |
...
| ![Public method](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/pubmethod.gif "Public method")![Static member](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/static.gif "Static member") | [Create](0f951f28-eb6b-2a37-668a-b248bfb7de97.htm) | Creates a new Viewport at a given location on a sheet. |
...
| ![Public method](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/pubmethod.gif "Public method") | [GetBoxCenter](10a5ede6-0c97-79e0-a31a-2ffd90c7fc97.htm) | Returns the center of the outline of the viewport on the sheet, excluding the viewport label. |
| ![Public method](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/pubmethod.gif "Public method") | [GetBoxOutline](034750ce-be6c-456b-7f3f-ee0ab5b5e2c0.htm) | Returns the outline of the viewport on the sheet, excluding the viewport label. |
...
| ![Public method](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/pubmethod.gif "Public method") | [GetLabelOutline](dcc1b956-d611-2554-a040-da9ed1633c06.htm) | Gets the outline viewport's label on the sheet. |
...
| ![Public method](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/pubmethod.gif "Public method") | [GetPositionAtViewAnchor](Viewport-Get-Position-At-View-Anchor-Method.md) | Gets the position coordinates at the ViewAnchor. |
| ![Public method](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/pubmethod.gif "Public method") | [GetProjectionToSheetTransform](3c55684a-b4fd-851e-3b32-6a3eb1e9eb3b.htm) | Returns the transform from the view's projection space to the sheet space. |
...
| ![Public method](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/pubmethod.gif "Public method") | [HasViewportTransforms](474169c5-2e94-ed0b-95e2-851d96dd3723.htm) | Indicates if the viewport has transforms. |
...
| ![Public method](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/pubmethod.gif "Public method") | [IsViewIdValidForViewport](9ab7aa51-8dce-bdda-10e5-7d2d3dfd09b2.htm) | Verifies that the Viewport can change it's view id to the input %viewId%. |
...
| ![Public method](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/pubmethod.gif "Public method") | [SetBoxCenter](71734b96-6582-e6c5-674a-e6c092ced0f2.htm) | Moves this viewport so that the center of the box outline (excluding the viewport label) is at a given point. |
...
| ![Public method](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/pubmethod.gif "Public method") | [SetViewAnchorAndPosition](Viewport-Set-View-Anchor-And-Position-Method.md) | Sets the ViewAnchor and position to Viewport. |
...
[Top](#PageHeader) ![](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/sectionexpanded.png)Remarks Viewports are used in Revit for purposes other than placement of
 ...
 SheetId property to filter these out. ![](https://d24b2zsrnzhmgb.cloudfront.net/static/img/chm/icons/sectionexpanded.png)See Also 
